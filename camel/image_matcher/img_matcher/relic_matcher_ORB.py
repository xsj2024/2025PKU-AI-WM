...
class RelicMatcher:
    ...
    def match(
        ...
        threshold: int = 8,  # Reduced threshold for ORB
        ...
        Args:
            ...
            threshold: Minimum number of good matches required (default: 15)
...
if __name__ == '__main__':
    relic = RelicMatcher()
    img = cv2.imread("img_matcher/49ebc4e4-8d6b-42cb-a5df-7ce2d08c603e.png")
